    ...
    <div className='nav__bar'>
      ...
      <div className="nav__right">
        ...
        <div className={`nav__menu${showSideNav ? ' show__nav-menu' : ''}`}>
          ...
          <Link to="/" >
            <li className={`nav__link ${location.pathname==="/" ? "active__link" : ""} `}>
            ...
            <Link to="/feeds" >
            <li className={`nav__link ${location.pathname==="/feeds" ? "active__link" : ""} `}>
              <i className="uil uil-postcard nav__icons"></i>
              Feeds
            </li>
            </Link>
            <Link to="/discuss">
            <li className={`nav__link ${location.pathname==="/discuss" ? "active__link" : ""} `}>
              <i className="uil uil-comments nav__icons"></i>
              Discuss
            </li>
            </Link>
            <Link to="/resources">
            <li className={`nav__link ${location.pathname==="/resources" ? "active__link" : ""} `}>
          ...
          <div className="theme" onClick={switchTheme} >
            <i className={`uil uil-${theme==="Dark"?'sun':'moon'} theme__btn`} ></i> {theme==="Light" ? "Dark" : "Light"} Theme
          </div>
      ...
      <div className="menu__bar">
        <i className={`uil uil-${theme==="Dark"?'sun':'moon'} theme__btn`} onClick={switchTheme}></i>
