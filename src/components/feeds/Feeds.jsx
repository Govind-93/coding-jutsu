          ...
          <div className="mid">
            <div className="input__container text-area">
              <textarea
                ...
                cols="0"
                rows="3"
                className="contact__input post__data"
                placeholder="Share your achievement/experience"
              ></textarea>
              <input
                id="upload-photo"
                type="file"
              ...
              {selectedImage && (
                <div
                  className="selected__image-container"
                  onClick={removeSelectedImage}
                >
                  <i class="uil uil-times remove__selected-image"></i>
                  <img
